...
Import-LocalizedData -BindingVariable CoreStrings -FileName Corefig.psd1
...
$FormMainMenu.Text = $CoreStrings.AppName
...
$checkboxStartup.Text = $CoreStrings.LoadAtStartup
...
$lblLogOff.Text = $CoreStrings.LogOffDotted
...
$lblRestart.Text = $CoreStrings.RestartDotted
...
$lblShutDown.Text = $CoreStrings.ShutDownDotted
...
$lblComputerInfo.Text = $CoreStrings.ComputerName
#~~< lblDomainInfo >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$lblDomainInfo.Text = $CoreStrings.WorkGroupOrDomain
#~~< lblVersionInfo >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$lblVersionInfo.Text = $CoreStrings.SKUVersion
#~~< lblComputerValue >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$btnClose.TabIndex = 2
$btnClose.Text = $CoreStrings.Exit
...
$lblCoreConfigText.Text = $CoreStrings.AppDescription
#~~< lblCoreConfigTitle >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$lblCoreConfigTitle.Text = $CoreStrings.TitleMain
...
$btnHyperV.Text = $CoreStrings.HyperVSettingsDotted
...
$btnNetwork.Text = $CoreStrings.NetworkSettingsDotted
...
$btnControlPanel.Text = $CoreStrings.ControlPanelDotted
...
$btnComputer.Text = $CoreStrings.ComputerSettingsDotted
...
$lblHyperv2.Text = $CoreStrings.HyperVDescription
#~~< pboxNetwork >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$lblNetwork2.Text = $CoreStrings.NetworkingDescription
#~~< pboxControl >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$lblControl2.Text = $CoreStrings.ControlPanelDescription
#~~< lblHyperV1 >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$lblHyperV1.Text = $CoreStrings.HyperVSettings
#~~< pboxComputer >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$lblNetwork1.Text = $CoreStrings.NetworkSettings
#~~< lblComputer2 >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$lblComputer2.Text = $CoreStrings.ComputerSettingsDescription
#~~< lblControl1 >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$menuTaskMgr.Text = $CoreStrings.TaskManager
...
$menuRegistry.Text = $CoreStrings.RegistryEditor
...
$menuClearLogFile.Text = $CoreStrings.ClearLogFile
...
$HelpLogsStripMenuItem.Text = $CoreStrings.Help
...
function Main
{
	...
	#Create Logfile
	$global:LogDirectory = $env:allusersprofile + "\Corefig"	# C:\ProgramData, usually
	if (!(Test-Path $LogDirectory))
	{ md $LogDirectory }
	$global:Logfile = $LogDirectory + "\CorefigLogfile.txt"
	$global:CoreUser = $env:userdomain + "\" + $env:username
	$CoreStrings.AppStart -f (Get-Date -F G), $CoreStrings.AppName, $CoreUser | Out-File -filepath $Logfile -append
	
	Get-Status
	ControlsMin
	$formMainMenu.ShowDialog()
	$FormMainMenu.BringToFront()
	$FormMainMenu.Activate()
}

function Computer
{
	$formMainMenu.Hide()
	. $ScriptDirectory\Computer.ps1
}
...
function licencing
{
	...
	. $ScriptDirectory\licencing.ps1
}

function HyperV
{
	$formMainMenu.enabled = $false
	. $ScriptDirectory\HyperV.ps1
}

function Network
{
	$formMainMenu.Hide()
	. $ScriptDirectory\Networking.ps1 -MPIOEnabled $MPIOEnabled
}

function ControlPanel
{
	$formMainMenu.Hide()
	. $ScriptDirectory\ControlPanel.ps1
}
...
function Global:MenuTaskMgr
{
	...
	$Shell.Run($Temp)
	#Output to Logfile
	$CoreStrings.LogCommandExecuted -f (Get-Date F -G), $Temp | Out-File -FilePath $Logfile -append
}
...
{
	#Output to Logfile
	$CoreStrings.LogCommandExecuted -f (Get-Date F -G), ($CoreStrings.LogClearedBy -f $CoreUser) | Out-File -FilePath $Logfile
	#Confirmation Dialog
	$Flag = $CoreStrings.ClearLogFile
	$Message = $CoreStrings.LogClearedBy -f $CoreUser
...
{
	#Output to Logfile
	$CoreStrings.AppExit -f (Get-Date -F G), $CoreStrings.AppName, $CoreUser | Out-File -FilePath $Logfile -append
	#Close form
	$FormMainMenu.Close()
}
...
function CheckboxStartupCheckedChanged( $object )
{
	if ($checkboxstartup.checked -eq $true)
	{
		...
		$Path = $ScriptDirectory + "\Start_Corefig.wsf"
...
{
	#Confirmation Dialog
	$Flag = $CoreStrings.LogoffWarning
	$Message = $CoreStrings.LogoffVerify
	. $ScriptDirectory\Common.ps1
	Message
	...
	{
		#Output to Logfile
		$CoreStrings.LogCommandExecuted -f (Get-Date F -G), ($CoreStrings.LogoffBy -f $CoreUser) | Out-File -FilePath $Logfile -append
		#Execute Logoff
		$Shell = New-Object -Comobject("WScript.Shell")
		$Temp = "Logoff"
		$Shell.Run($Temp)
...
{
	#Confirmation Dialog
	$Flag = $CoreStrings.RestartWarning
	$Message = $CoreStrings.RestartVerify
	. $ScriptDirectory\Common.ps1
	Message
	$pboxWarning.visible = $true
	$frmMessage.ShowDialog()
	...
	{
		#Output to Logfile
		$CoreStrings.LogCommandExecuted -f (Get-Date F -G), ($CoreStrings.RestartBy -f $CoreUser) | Out-File -FilePath $Logfile -append
		#Execute Restart
...
{
	#Confirmation Dialog
	$Flag = $CoreStrings.ShutdownWarning
	$Message = $CoreStrings.ShutdownVerify
	. $ScriptDirectory\Common.ps1
	Message
	$pboxWarning.visible = $true
	$frmMessage.ShowDialog()
	...
	{
		#Output to Logfile
		$CoreStrings.LogCommandExecuted -f (Get-Date F -G), ($CoreStrings.ShutdownBy -f $CoreUser) | Out-File -FilePath $Logfile -append
		Stop-Computer -Force
	}
}
