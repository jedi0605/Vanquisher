...
$Label12.Size = New-Object System.Drawing.Size(140, 15)
$Label12.TabIndex = 0
...
$ListWinRM.Location = New-Object System.Drawing.Point(249, 296)
...
$pboxpublicUpArrow.Location = New-Object System.Drawing.Point(407, 4)
...
$pboxpublicdownArrow.Location = New-Object System.Drawing.Point(407, 4)
...
$pboxprivateUpArrow.Location = New-Object System.Drawing.Point(407, 4)
...
$pboxprivatedownArrow.Location = New-Object System.Drawing.Point(407, 4)
...
$pboxDomainUpArrow.Location = New-Object System.Drawing.Point(407, 3)
...
$pboxDomaindownArrow.Location = New-Object System.Drawing.Point(407, 3)
...
function CheckConfiguration
{
	...
	try
	{
		if ((Get-NetFirewallRule -Name FPSSMBD-iWARP-In-TCP -ErrorAction Stop).Enabled -eq "True")
		{ $ListSMBD.SelectedIndex = 0 }
		else { $ListSMBD.SelectedIndex = 1 }
		$ListSMBD.Enabled = $True
	}
	catch
	{
		# This rule doesn't even exist if SMB Direct isn't installed
		$ListSMBD.SelectedIndex = 1
		$ListSMBD.Enabled = $False
	}
...
function OK
{
	...
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.WindowsFirewallRemoteManagement, $RuleStatus | Out-File -FilePath $Logfile -append
	...
	#SMBDirect
	if($ListSMBD.Enabled)	# will be disabled if the feature is not installed
	{
	...
	#Output to Logfile
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.SMBDirect, $RuleStatus | Out-File -FilePath $Logfile -append
	...
	#Output to Logfile
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.EventLogManagement, $RuleStatus | Out-File -FilePath $Logfile -append
	#Service Management
	...
	#Output to Logfile
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.ServiceManagement, $RuleStatus | Out-File -FilePath $Logfile -append
	#Remote Volume Management
	...
	#Output to Logfile
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.RemoteVolumeManagement, $RuleStatus | Out-File -FilePath $Logfile -append
	#Remote Scheduled Tasks Management
	...
	#Output to Logfile
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.RemoteScheduledTaskManagement, $RuleStatus | Out-File -FilePath $Logfile -append
	#Remote Desktop
	...
	#Output to Logfile
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.RemoteDesktop, $RuleStatus | Out-File -FilePath $Logfile -append
	...
	#Output to Logfile
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.FileAndPrinterSharing, $RuleStatus | Out-File -FilePath $Logfile -append
	...
	#Output to Logfile
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.PingDescription, $RuleStatus | Out-File -FilePath $Logfile -append
	...
	#Output to Logfile
	$TextStrings.LogRuleGroupChanged -f (Get-Date -F G), $TextStrings.WindowsRemoteManagement, $RuleStatus | Out-File -FilePath $Logfile -append
	...
	if ($ChkboxDomainEnable.Checked)
	{
		if ((Get-NetFirewallProfile -Name Domain).Enabled -ne "True")
		{
			...
			#Output to Logfile
			$TextStrings.LogProfileChanged -f (Get-Date -F G), $TextStrings.Domain, $TextStrings.Enabled | Out-File -FilePath $Logfile -Append
		}
	}
	if ($ChkboxDomainDisable.Checked)
	{
		if ((Get-NetFirewallProfile -Name Domain).Enabled -ne "False")
		{
			...
			#Output to Logfile
			$TextStrings.LogProfileChanged -f (Get-Date -F G), $TextStrings.Domain, $TextStrings.Disabled | Out-File -FilePath $Logfile -Append
		}
	}
	if ($ChkboxPrivateEnable.Checked)
	{
		if ((Get-NetFirewallProfile -Name Private).Enabled -ne "True")
		{
			...
			#Output to Logfile
			$TextStrings.LogProfileChanged -f (Get-Date -F G), $TextStrings.Private, $TextStrings.Enabled | Out-File -FilePath $Logfile -Append
		}
	}
	if ($ChkboxPrivateDisable.Checked)
	{
		if ((Get-NetFirewallProfile -Name Private).Enabled -ne "False")
		{
			...
			#Output to Logfile
			$TextStrings.LogProfileChanged -f (Get-Date -F G), $TextStrings.Private, $TextStrings.Disabled | Out-File -FilePath $Logfile -Append
		}
	}
	if ($ChkboxPublicEnable.Checked)
	{
		if ((Get-NetFirewallProfile -Name Public).Enabled -ne "True")
		{
			...
			#Output to Logfile
			$TextStrings.LogProfileChanged -f (Get-Date -F G), $TextStrings.Public, $TextStrings.Enabled | Out-File -FilePath $Logfile -Append
		}
	}
	if ($ChkboxPublicDisable.Checked)
	{
		if ((Get-NetFirewallProfile -Name Public).Enabled -ne "False")
		{
			...
			#Output to Logfile
			$TextStrings.LogProfileChanged -f (Get-Date -F G), $TextStrings.Public, $TextStrings.Disabled | Out-File -FilePath $Logfile -Append
		}
	}
