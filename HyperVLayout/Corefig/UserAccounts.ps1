...
function RemoveUsers
{
	...
	#Output to Logfile
	$TextStrings.LogUserRemoved -f (Get-Date -F G), $usernametoremove, $GroupName | Out-File -FilePath $Logfile -append
...
{ 
	...
	#Output to Logfile
	$TextStrings.LogUserAdded -f (Get-Date -F G), $userNameToAdd, $GroupName | Out-File -FilePath $Logfile -append
